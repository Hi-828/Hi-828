...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Pacifico&color=%2336BCF7&size=48&center=true&vCenter=true&width=1200&height=100&lines=Senior+Software+Engineer;Senior+Software+Engineer)]()
...
## Skills
- 🌱 Frontend: React, Next, Angular, Vue, Nuxt, Jquery, Material UI, Bootstrap, TailwindCSS
- 🔭 Backend: Spring, Spring Boot, NodeJs, Laravel, Django, Flask, Express, Nestjs, PHP, 
- 📲 Mobile: Android, React Native, Ionic, Flutter
- 🧩 Database: MySQL, PostgreSQL, MongoDB, Firestore, MariaDB, SQLite, AES Lambda, Spring Cloud, NoSQL
- 💬 Language: HTML, CSS, Javascript, Python, Java, Core Java, Typescript, Python, PHP, C++, C#, Go
